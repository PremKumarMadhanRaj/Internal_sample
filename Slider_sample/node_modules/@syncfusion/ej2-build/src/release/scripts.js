        ...
        if (configJson && configJson.components && configJson.components.length > 0) {
            ...
            for (var comp of comps) {
                ...
                if (matchReg && matchReg[1]) {
                    ...
                    var depJson = fs.existsSync('./third-party/') ? `sfBlazor.dependencyJson.${compName}` :
...
sfBlazor.initBlazorAdaptor();` : '';
    ...
    // blazor library or single bundle scripts
        ...
        sfBlazor.initBlazorAdaptor();` : '';
            ...
            var libScript = config.blazorDependencies.isSingleBundle ? getSingleBundleModules(packName) :
                baseScript;
            var replaceContent = `});
${libScript}
...
function blazorGlobalScriptsGenerator(config, srcPath) {
    ...
    var compConfig = { compClassNames: {}, moduleNames: {} };
    var comps = [];
